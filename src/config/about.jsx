export const about = [
    ...
    A major component of GhostOpsAI is the mission generator which was inspired by RGJP’s incredible work on the original Ghost Recon Breakpoint mission generator. With RGJP's permission, this feature was re-imagined and integrated into GhostOpsAI, allowing players to generate realistic, AI-assisted missions based on terrain, enemy intel, and operational goals.
    GhostOpsAI is more than just a game tool—it’s a living simulation for fans of tactical realism and strategic planning.`,
	},
];
