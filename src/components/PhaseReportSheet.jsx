...
const SCREENS = ["OUTCOME", "TEAM & INSERTION", "COMPLICATIONS", "CASUALTIES"];

// ─── Infil methods ────────────────────────────────────────────────────────────

const INFIL_METHODS = [
	{ id: "foot", label: "Foot", sub: "Foot movement" },
	{ id: "vehicle", label: "Vehicle", sub: "Ground vehicle" },
	{ id: "boat", label: "Boat", sub: "Water insertion" },
	{ id: "lalo", label: "LALO", sub: "Low altitude parachute" },
	{ id: "haho", label: "HAHO", sub: "High altitude parachute" },
	{ id: "helicopter", label: "Helicopter", sub: "Rotary wing" },
];
...
const CASUALTY_OPTIONS = [
	...
	{
		id: "missing",
		label: "Operator MIA / unknown fate",
...
const O = (id, label, sub, color, border, activeBg, dot) => ({
	id,
	label,
	sub,
	color,
...
const OUTCOME_BY_MISSION = {
	...
	DA_RAID: [
		...
		O(
			"compromised",
			"Objective complete",
			"Element compromised during infil or on objective",
			"text-yellow-400",
		...
		O(
			"heavy",
			"Objective complete",
			"Sustained heavy contact — high ammo expenditure",
			"text-orange-400",
		...
		O(
			"partial",
			"Partial success",
			"Secondary target missed or not engaged",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			...
			"Mission aborted — objective not reached",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	DA_AMBUSH: [
		O(
			"clean",
			"Effective ambush",
			"Kill zone effective — target destroyed",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			...
			"Some elements escaped the kill zone",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"heavy",
			"Objective complete",
			"Kill zone held — sustained return fire",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			...
			"Convoy rerouted — no contact initiated",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			"overrun",
			"Position overrun",
			"Kill zone breached — element broke contact",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	DA_SNATCH: [
		O(
			"clean",
			"HVT secured",
			"Exfil successful — HVT in custody",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"hot_exfil",
			"HVT secured",
			"Exfil under contact — custody maintained",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"hvt_escaped",
			"HVT escaped",
			"Target fled during breach or transit",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"hvt_kia",
			"HVT killed",
			"Target KIA — custody objective failed",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
		...
		O(
			"aborted",
			"Mission aborted",
			"Target not viable — operation called off",
			"text-purple-400",
	...
	DA_ELIMINATION: [
		...
		O(
			"compromised",
			"HVT neutralized",
			"Kill confirmed — element compromised during exfil",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"heavy",
			"HVT neutralized",
			"Kill confirmed — sustained heavy contact",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"target_fled",
			"HVT escaped",
			"Target evaded before engagement",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	DA_SABOTAGE: [
		O(
			"clean",
			"Target destroyed",
			"Demolition successful — clean exfil",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"partial",
			"Partial demolition",
			"Target damaged — not fully destroyed",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"heavy",
			"Target destroyed",
			"Demo successful — element took contact on exfil",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"charges_lost",
			"Demo failed",
			"Charges lost or placed incorrectly",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
		...
		O(
			"aborted",
			"Mission aborted",
			"Target not accessible — operation called off",
			"text-purple-400",
			"border-purple-500/40",
			"bg-purple-500/10",
			"bg-purple-400",
	...
	DA_STRIKE: [
		O(
			"clean",
			"Node destroyed",
			"Strike complete — no collateral damage",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"partial",
			"Node degraded",
			"Partial destruction — redundant systems intact",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"heavy",
			"Node destroyed",
			"Strike complete — sustained contact on exfil",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"collateral",
			"Node destroyed",
			"Strike complete — unintended collateral damage",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			"aborted",
			"Strike aborted",
			"Target location denied — operation called off",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	DA_CONVOY: [
		O(
			"clean",
			"Convoy destroyed",
			"Interdiction complete — all vehicles neutralized",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"partial",
			"Partial interdiction",
			"Lead elements destroyed — rear elements escaped",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"heavy",
			"Convoy destroyed",
			"Mission complete — QRF responded during exfil",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"no_show",
			"Convoy did not appear",
			"Target rerouted — no contact initiated",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			"aborted",
			"Mission aborted",
			"Position compromised — operation called off",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	SR_AREA: [
		O(
			"clean",
			"Collection complete",
			"Full window — no compromise, no contact",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"partial",
			"Partial collection",
			"Window cut short — exfil forced early",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"compromised",
			"Collection complete",
			"Full window — element detected on exfil",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"nothing",
			"No actionable intel",
			"Collection window complete — no new intelligence",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			"aborted",
			"Mission aborted",
			"OP position blown — element exfiled immediately",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	SR_POINT: [
		O(
			"clean",
			"OP complete",
			"Observation dwell met — no compromise",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"extended",
			"OP extended",
			"Dwell extended — additional intelligence gathered",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"cut_short",
			"OP cut short",
			"Dwell incomplete — exfil forced before window",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"compromised",
			"OP blown",
			"Position detected — emergency exfil executed",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
		...
		O(
			"nothing",
			"No actionable intel",
			"OP complete — target activity not observed",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
	...
	SR_BDA: [
		O(
			...
			"Target neutralized — BDA complete",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			...
			"Target degraded — not fully destroyed",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"intact",
			"Target intact",
			"Strike ineffective — target operational",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"denied",
			"BDA denied",
			"Area too hot — assessment incomplete",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
		...
		O(
			"secondary",
			"Secondary target found",
			"BDA revealed additional high-value target",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
	...
	CT_HOSTAGE: [
		O(
			...
			"Assault complete — element and hostages intact",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"partial",
			"Partial recovery",
			"Some hostages recovered — others unaccounted for",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"hot_exfil",
			"Hostages recovered",
			"All recovered — sustained contact during exfil",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"hostage_kia",
			"Hostage KIA",
			"One or more hostages killed during operation",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
		...
		O(
			"aborted",
			"Assault aborted",
			"Too high a risk — operation called off",
			"text-purple-400",
			"border-purple-500/40",
			"bg-purple-500/10",
			"bg-purple-400",
	...
	CT_STRIKE: [
		O(
			"clean",
			"Target neutralized",
			"Strike complete — ROE maintained",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"compromised",
			"Target neutralized",
			"Strike complete — civilian presence encountered",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"heavy",
			"Target neutralized",
			"Strike complete — sustained enemy contact",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"partial",
			"Partial success",
			"Primary target hit — secondary network intact",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			"aborted",
			"Strike aborted",
			"Positive ID not confirmed — ROE not met",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	CT_RECOVERY: [
		O(
			"clean",
			"Personnel recovered",
			"Isolated individual recovered — element intact",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"under_fire",
			"Personnel recovered",
			"Recovery successful — sustained contact during exfil",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"critical",
			"Personnel recovered",
			"Individual recovered — critical medical status",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"personnel_kia",
			"Personnel KIA",
			"Isolated individual KIA before recovery",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
		...
		O(
			"aborted",
			"Recovery aborted",
			"Location too compromised — operation called off",
			"text-purple-400",
			"border-purple-500/40",
			"bg-purple-500/10",
			"bg-purple-400",
	...
	OW_OVERWATCH: [
		O(
			...
			"Supported element cleared — no contact on position",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"engaged",
			"Position under fire",
			"Overwatch position taken under direct fire",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"displaced",
			"Position displaced",
			"Element displaced — alternate position occupied",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"fires_called",
			"Direct fires called",
			"Sniper or support fires engaged threat element",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			"aborted",
			"Overwatch not established",
			"Position could not be reached — insertion failed",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
	...
	OW_RESUPPLY: [
		O(
			"clean",
			"Resupply complete",
			"All materiel delivered — route clear",
			"text-green-400",
			"border-green-500/40",
			"bg-green-500/10",
			"bg-green-400",
		...
		O(
			"contact",
			"Resupply complete",
			"Delivery made — route interdicted during transit",
			"text-yellow-400",
			"border-yellow-500/40",
			"bg-yellow-500/10",
			"bg-yellow-400",
		...
		O(
			"partial",
			"Partial delivery",
			"Some materiel lost — element took losses en route",
			"text-orange-400",
			"border-orange-500/40",
			"bg-orange-500/10",
			"bg-orange-400",
		...
		O(
			"route_denied",
			"Route denied",
			"Primary route too hot — alternate not viable",
			"text-blue-400",
			"border-blue-500/40",
			"bg-blue-500/10",
			"bg-blue-400",
		...
		O(
			"aborted",
			"Mission aborted",
			"Resupply called off — recipient element moved",
			"text-red-400",
			"border-red-500/40",
			"bg-red-500/10",
			"bg-red-400",
...
function getQuestionnaire(missionTypeId) {
	...
	const outcomes =
		OUTCOME_BY_MISSION[missionTypeId] ?? OUTCOME_BY_MISSION["DA_RAID"];
	const complications =
		COMPLICATIONS_BY_CATEGORY[category] ??
		COMPLICATIONS_BY_CATEGORY["Direct Action"];
	...
	return (
		<div className='flex flex-col gap-4 p-4'>
			...
			<div className='flex flex-col gap-2'>
				...
				<div className='grid grid-cols-2 gap-1.5'>
					{INFIL_METHODS.map((m) => {
						const active = infilMethodUsed === m.id;
						return (
							<button
								key={m.id}
								onClick={() => onInfilMethodUsed(active ? "" : m.id)}
								className={[
									"flex flex-col gap-0.5 px-3 py-2.5 border rounded-sm text-left transition-all",
									active ?
										"border-btn/50 bg-btn/10"
									:	"border-lines/15 hover:border-lines/30 bg-transparent",
								].join(" ")}>
								<span
									className={`font-mono text-[10px] tracking-wider uppercase ${active ? "text-btn" : "text-lines/45"}`}>
									{m.label}
								</span>
...
export default function PhaseReportSheet({ mission, phaseNumber, onSave }) {
	...
	const canProceed = {
		1: !!outcome,
		2: true, // optional screen — always allow advance
		3: complications.length > 0,
		4: !!casualties,
	};
